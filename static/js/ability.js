const abilities = {
  ...
  tier2: {
    ...
    police: { 경찰: "수색", 자경단원: "숙청" },
    doctor: { 의사: "치료" },
    special: { 군인: "방탄", 정치인: "처세", 영매: "성불", 연인: "희생", 기자: "특종", 건달: "공갈", 사립탐정: "추리", 도굴꾼: "도굴", 테러리스트: "자폭", 성직자: "소생", 예언자: "계시", 간호사: "처방", 판사: "선고", 마술사: "트릭", 해커: "해킹", 심리학자: "관찰", 용병: "의뢰", 공무원: "조회", 비밀결사: "밀사", 파파라치: "이슈", 시민: null },
    cult: { 교주: "포교" }
  },
